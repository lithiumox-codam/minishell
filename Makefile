NAME = minishell
SRC = main check_input utils/error structs/token parser/index parser/tokens2 parser/quotes parser/tokens debug/print_vector lexer/index lexer/string utils/init structs/env
