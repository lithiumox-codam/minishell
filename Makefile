NAME = minishell
SRC = main check_input utils/error structs/token structs/group parser/index parser/tokens2 parser/quotes parser/tokens debug/print_vector lexer/index lexer/string lexer/token utils/init structs/env utils/global exec/group exec/heredoc parser/verify_token
