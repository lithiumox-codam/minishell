...
/*   Updated: 2023/10/26 13:02:54 by mdekker/jde   ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
t_func_map	*return_map(void)
{
	...
	func_map[3] = (t_func_map){is_pipe, PIPE};
	func_map[4] = (t_func_map){is_r_redirect, O_REDIRECT};
	func_map[5] = (t_func_map){is_l_redirect, I_REDIRECT};
	func_map[6] = (t_func_map){is_a_redirect, A_REDIRECT};
	func_map[7] = (t_func_map){is_heredoc, HEREDOC};
	func_map[8] = (t_func_map){NULL, STRING};
	return (func_map);
}
